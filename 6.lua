_G.V4 = true  -- Đặt _G.V4 là true để tự động kích hoạt

spawn(function()
    while true do
        pcall(function()
            if _G.V4 then
                -- Thực hiện hành động mà không cần nhấn phím, ví dụ là kích hoạt kỹ năng hoặc tính năng nào đó
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Skill", "Activate")  -- Thay đổi tên hàm và tham số theo yêu cầu
            end
        end)
